<?php
// Call CalendarTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'CalendarTest::main');
}

require_once 'PHPUnit/Framework.php';

require_once APPLICATION_HOME.'/classes/Calendar.inc';
...
class CalendarTest extends PHPUnit_Framework_TestCase {
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('CalendarTest');
    ...
    /**
     * @todo Implement testGetEventRecurrenceArray().
     */
    public function testGetEventRecurrenceArray() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
          'This test has not been implemented yet.'
        );
...
// Call CalendarTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'CalendarTest::main') {
    CalendarTest::main();
}
?>
